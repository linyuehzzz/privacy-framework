    ...
    for i in r:
        ...
        for j in range(intervals + 1):
            ...
            try:
                ...
                fw.write(str(i) + ',' + ',' + str(epsilon) + ',' + "VER" + ',' + ',' + ',' + '\n')
                fw.write(str(i) + ',' + ',' + str(epsilon) + ',' + "ER" + ',' + ',' + ',' + '\n')
                fw.write(str(i) + ',' + ',' + str(epsilon) + ',' + "R" + ',' + ',' + ',' + '\n')
                fw.flush()
